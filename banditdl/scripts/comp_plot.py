...
from banditdl.utils.results import compute_avg_err_op
  ...
  for nb_neighbors in [3,4,5]:#[15]:#
    for worst in [True, False]:
      ...
      for method in methods:
        ...
        print(name_fx)
        brdl = compute_avg_err_op(name_fx, seeds_fx, result_directory_fx, ev, ("Accuracy", "mean"))
        plot.include(brdl[0], "Accuracy", errs="-err", lalp=0.8)

      brdl_el = compute_avg_err_op(name, seeds, result_directory_el, ev, ("Accuracy", "mean")) 
